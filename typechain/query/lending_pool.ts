...
export default class LendingPoolMethods {
	...
	*/
	"chooseMarketRule" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolActions::chooseMarketRule", [marketRuleId], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setAsCollateral" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolActions::setAsCollateral", [asset, useAsCollateral], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"deposit" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolActions::deposit", [asset, onBehalfOf, amount, data], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"withdraw" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolActions::withdraw", [asset, onBehalfOf, amount, data], __options , (result) => { return handleReturnType(result, getTypeDescription(135, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"borrow" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolActions::borrow", [asset, onBehalfOf, amount, data], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"repay" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolActions::repay", [asset, onBehalfOf, amount, data], __options , (result) => { return handleReturnType(result, getTypeDescription(135, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"multiOp" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolActions::multiOp", [actions, onBehalfOf, data], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"liquidate" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolActions::liquidate", [liquidatedAccount, assetToRepay, assetToTake, amountToRepay, minimumRecievedForOneRepaidTokenE18, data], __options , (result) => { return handleReturnType(result, getTypeDescription(141, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"flashLoan" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolFlash::flashLoan", [receiver, assets, amounts, receiverParams], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"accumulateInterest" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolMaintain::accumulateInterest", [asset], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"adjustRateAtTarget" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolMaintain::adjustRateAtTarget", [asset, guessedIndex], __options , (result) => { return handleReturnType(result, getTypeDescription(146, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setPriceFeedProvider" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolManage::setPriceFeedProvider", [priceFeedProvider], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setFeeReductionProvider" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolManage::setFeeReductionProvider", [feeReductionProvider], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setFlashLoanFeeE6" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolManage::setFlashLoanFeeE6", [flashLoanFeeE6], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"registerAsset" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolManage::registerAsset", [asset, aTokenCodeHash, vTokenCodeHash, name, symbol, decimals, assetRules, reserveRestrictions, reserveFees, interestRateModel], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setReserveIsActive" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolManage::setReserveIsActive", [asset, active], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setReserveIsFrozen" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolManage::setReserveIsFrozen", [asset, freeze], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setInterestRateModel" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolManage::setInterestRateModel", [asset, interestRateModel], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setReserveRestrictions" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolManage::setReserveRestrictions", [asset, reserveRestrictions], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setReserveFees" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolManage::setReserveFees", [asset, reserveFees], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"addMarketRule" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolManage::addMarketRule", [marketRule], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"modifyAssetRule" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolManage::modifyAssetRule", [marketRuleId, asset, assetRules], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"takeProtocolIncome" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolManage::takeProtocolIncome", [assets, to], __options , (result) => { return handleReturnType(result, getTypeDescription(152, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setStablecoinDebtRateE18" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolManage::setStablecoinDebtRateE18", [asset, debtRateE18], __options , (result) => { return handleReturnType(result, getTypeDescription(122, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"transferDepositFromTo" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolATokenInterface::transferDepositFromTo", [underlyingAsset, from, to, amount], __options , (result) => { return handleReturnType(result, getTypeDescription(141, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"transferDebtFromTo" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "lendingPoolVTokenInterface::transferDebtFromTo", [underlyingAsset, from, to, amount], __options , (result) => { return handleReturnType(result, getTypeDescription(141, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"grantRole" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "accessControl::grantRole", [role, account], __options , (result) => { return handleReturnType(result, getTypeDescription(190, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"revokeRole" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "accessControl::revokeRole", [role, account], __options , (result) => { return handleReturnType(result, getTypeDescription(190, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"renounceRole" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "accessControl::renounceRole", [role, account], __options , (result) => { return handleReturnType(result, getTypeDescription(190, DATA_TYPE_DESCRIPTIONS)); });
	}
