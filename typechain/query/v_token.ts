...
export default class VTokenMethods {
	...
	*/
	"emitTransferEvents" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "abacusToken::emitTransferEvents", [transferEventData], __options , (result) => { return handleReturnType(result, getTypeDescription(45, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"emitTransferEventAndDecreaseAllowance" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "abacusToken::emitTransferEventAndDecreaseAllowance", [transferEventData, from, to, decreaseAllowanceBy], __options , (result) => { return handleReturnType(result, getTypeDescription(45, DATA_TYPE_DESCRIPTIONS)); });
	}
