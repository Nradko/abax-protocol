...
export default class FlashLoanReceiverMockMethods {
	...
	*/
	"setFailExecuteOperation" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "setFailExecuteOperation", [shouldFailExecuteOperation], __options , (result) => { return handleReturnType(result, getTypeDescription(4, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setCustomAmountToApprove" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "setCustomAmountToApprove", [customAmountToApprove], __options , (result) => { return handleReturnType(result, getTypeDescription(4, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setSimulateBalanceToCoverFee" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "setSimulateBalanceToCoverFee", [simulateBalanceToCoverFee], __options , (result) => { return handleReturnType(result, getTypeDescription(4, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"executeOperation" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "flashLoanReceiver::executeOperation", [assets, amounts, fees, receiverParams], __options , (result) => { return handleReturnType(result, getTypeDescription(13, DATA_TYPE_DESCRIPTIONS)); });
	}
