...
export default class EventsClass {
	...
	public subscribeOnExecutedWithSuccessEvent(callback : (event : EventTypes.ExecutedWithSuccess) => void) {
		...
		return this.__subscribeOnEvent(callbackWrapper, (signatureTopic : string) => signatureTopic === '0x63ebc6028b9b9e0cb557e0e706191a3dc930d95984f31d4ea1e6dd8a43127ab0');
	}
