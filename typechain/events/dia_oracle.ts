...
export default class EventsClass {
	...
	public subscribeOnOwnershipTransferredEvent(callback : (event : EventTypes.OwnershipTransferred) => void) {
		...
		return this.__subscribeOnEvent(callbackWrapper, (signatureTopic : string) => signatureTopic === '0xf363ee3187c9dfdb16a8d9436920bc4e73b5e9cc4ce69a2ad51fdbb4bc105b39');
	}
	...
	public subscribeOnUpdaterChangedEvent(callback : (event : EventTypes.UpdaterChanged) => void) {
		...
		return this.__subscribeOnEvent(callbackWrapper, (signatureTopic : string) => signatureTopic === '0x30dc916d115e1f67227a6c63b7dfc08de7c2cf284fc50891334f1848abf1481b');
	}
	...
	public subscribeOnTokenPriceChangedEvent(callback : (event : EventTypes.TokenPriceChanged) => void) {
		...
		return this.__subscribeOnEvent(callbackWrapper, (signatureTopic : string) => signatureTopic === '0x28053f279c683bfadeb53d25879f1c616b885477142009a6def019e2e1e5df90');
	}
