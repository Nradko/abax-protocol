...
export default class PriceFeedProviderMethods {
   ...
   * @param { string } symbol,
   */
  setAccountSymbol(asset: ArgumentTypes.AccountId, symbol: string, __options?: ContractOptions) {
   ...
   * @param { ArgumentTypes.AccountId } asset,
   */
  getAccountSymbol(asset: ArgumentTypes.AccountId, __options?: ContractOptions) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   */
  getLatestPrices(assets: Array<ArgumentTypes.AccountId>, __options?: ContractOptions) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
