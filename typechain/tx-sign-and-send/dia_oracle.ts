...
export default class DiaOracleMethods {
   ...
   *
   */
  codeHash(__options?: ContractOptions) {
   ...
   */
  setUpdater(updater: ArgumentTypes.AccountId, __options?: ContractOptions) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   */
  setPrice(pair: string, price: string | number | BN, __options?: ContractOptions) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   */
  setPrices(pairs: Array<[string, string | number | BN]>, __options?: ContractOptions) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
      'oracleSetters::setPrices',
      (events: EventRecord[]) => {
        return decodeEvents(events, this.__nativeContract, EVENT_DATA_TYPE_DESCRIPTIONS);
      },
      [pairs],
   ...
   *
   */
  getUpdater(__options?: ContractOptions) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
      'oracleGetters::getUpdater',
      (events: EventRecord[]) => {
        return decodeEvents(events, this.__nativeContract, EVENT_DATA_TYPE_DESCRIPTIONS);
      },
      [],
   ...
   * @param { string } pair,
   */
  getLatestPrice(pair: string, __options?: ContractOptions) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   */
  getLatestPrices(pairs: Array<string>, __options?: ContractOptions) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
