...
export default class Methods {
   ...
   */
  setCode(codeHash: Array<number | string | BN>, __options: ContractOptions) {
   ...
   */
  chooseMarketRule(marketRuleId: number | string | BN, __options: ContractOptions) {
   ...
   */
  setAsCollateral(asset: ArgumentTypes.AccountId, useAsCollateral: boolean, __options: ContractOptions) {
   ...
   * @param { Array<(number | string | BN)> } data,
   */
  multiOp(actions: Array<ArgumentTypes.Action>, onBehalfOf: ArgumentTypes.AccountId, data: Array<number | string | BN>, __options: ContractOptions) {
   ...
   * @param { ArgumentTypes.AccountId } asset,
   */
  accumulateInterest(asset: ArgumentTypes.AccountId, __options: ContractOptions) {
   ...
   */
  setPriceFeedProvider(priceFeedProvider: ArgumentTypes.AccountId, __options: ContractOptions) {
    return buildSubmittableExtrinsic(
      this.__apiPromise,
      this.__nativeContract,
   ...
   */
  setFeeReductionProvider(feeReductionProvider: ArgumentTypes.AccountId, __options: ContractOptions) {
    return buildSubmittableExtrinsic(
      this.__apiPromise,
      this.__nativeContract,
   ...
   */
  setFlashLoanFeeE6(flashLoanFeeE6: string | number | BN, __options: ContractOptions) {
   ...
   */
  setReserveIsActive(asset: ArgumentTypes.AccountId, active: boolean, __options: ContractOptions) {
   ...
   */
  setReserveIsFrozen(asset: ArgumentTypes.AccountId, freeze: boolean, __options: ContractOptions) {
   ...
   */
  setInterestRateModel(asset: ArgumentTypes.AccountId, interestRateModel: Array<number | string | BN>, __options: ContractOptions) {
    return buildSubmittableExtrinsic(
      this.__apiPromise,
      this.__nativeContract,
   ...
   * @param { ArgumentTypes.ReserveRestrictions } reserveRestrictions,
   */
  setReserveRestrictions(asset: ArgumentTypes.AccountId, reserveRestrictions: ArgumentTypes.ReserveRestrictions, __options: ContractOptions) {
    return buildSubmittableExtrinsic(
      this.__apiPromise,
      this.__nativeContract,
   ...
   * @param { ArgumentTypes.SetReserveFeesArgs } reserveFees,
   */
  setReserveFees(asset: ArgumentTypes.AccountId, reserveFees: ArgumentTypes.SetReserveFeesArgs, __options: ContractOptions) {
   ...
   */
  addMarketRule(marketRule: Array<ArgumentTypes.AssetRules | null>, __options: ContractOptions) {
   ...
   */
  takeProtocolIncome(assets: Array<ArgumentTypes.AccountId> | null, to: ArgumentTypes.AccountId, __options: ContractOptions) {
   ...
   */
  setStablecoinDebtRateE18(asset: ArgumentTypes.AccountId, debtRateE18: number | string | BN, __options: ContractOptions) {
    return buildSubmittableExtrinsic(
      this.__apiPromise,
      this.__nativeContract,
   ...
   *
   */
  viewFlashLoanFeeE6(__options: ContractOptions) {
   ...
   */
  viewAssetId(account: ArgumentTypes.AccountId, __options: ContractOptions) {
   ...
   *
   */
  viewRegisteredAssets(__options: ContractOptions) {
   ...
   * @param { ArgumentTypes.AccountId } asset,
   */
  viewReserveData(asset: ArgumentTypes.AccountId, __options: ContractOptions) {
   ...
   * @param { ArgumentTypes.AccountId } asset,
   */
  viewUnupdatedReserveIndexes(asset: ArgumentTypes.AccountId, __options: ContractOptions) {
   ...
   * @param { ArgumentTypes.AccountId } asset,
   */
  viewInterestRateModel(asset: ArgumentTypes.AccountId, __options: ContractOptions) {
   ...
   * @param { ArgumentTypes.AccountId } asset,
   */
  viewReserveRestrictions(asset: ArgumentTypes.AccountId, __options: ContractOptions) {
   ...
   * @param { ArgumentTypes.AccountId } asset,
   */
  viewReserveTokens(asset: ArgumentTypes.AccountId, __options: ContractOptions) {
   ...
   * @param { ArgumentTypes.AccountId } asset,
   */
  viewReserveDecimalMultiplier(asset: ArgumentTypes.AccountId, __options: ContractOptions) {
   ...
   * @param { ArgumentTypes.AccountId } asset,
   */
  viewReserveIndexes(asset: ArgumentTypes.AccountId, __options: ContractOptions) {
   ...
   * @param { ArgumentTypes.AccountId } asset,
   */
  viewReserveFees(asset: ArgumentTypes.AccountId, __options: ContractOptions) {
   ...
   * @param { ArgumentTypes.AccountId } account,
   */
  viewUnupdatedAccountReserveData(asset: ArgumentTypes.AccountId, account: ArgumentTypes.AccountId, __options: ContractOptions) {
    return buildSubmittableExtrinsic(
      this.__apiPromise,
      this.__nativeContract,
   ...
   * @param { ArgumentTypes.AccountId } account,
   */
  viewAccountReserveData(asset: ArgumentTypes.AccountId, account: ArgumentTypes.AccountId, __options: ContractOptions) {
    return buildSubmittableExtrinsic(
      this.__apiPromise,
      this.__nativeContract,
   ...
   * @param { ArgumentTypes.AccountId } account,
   */
  viewAccountConfig(account: ArgumentTypes.AccountId, __options: ContractOptions) {
   ...
   * @param { (number | string | BN) } marketRuleId,
   */
  viewMarketRule(marketRuleId: number | string | BN, __options: ContractOptions) {
   ...
   */
  getAccountFreeCollateralCoefficient(accountAddress: ArgumentTypes.AccountId, __options: ContractOptions) {
    return buildSubmittableExtrinsic(
      this.__apiPromise,
      this.__nativeContract,
   ...
   * @param { Array<ArgumentTypes.AccountId> | null } assets,
   */
  viewProtocolIncome(assets: Array<ArgumentTypes.AccountId> | null, __options: ContractOptions) {
   ...
   */
  viewCounterToAccount(counter: string | number | BN, __options: ContractOptions) {
   ...
   * @param { ArgumentTypes.AccountId } account,
   */
  viewAccountToCounter(account: ArgumentTypes.AccountId, __options: ContractOptions) {
   ...
   *
   */
  viewNextCounter(__options: ContractOptions) {
   ...
   */
  totalDepositOf(underlyingAsset: ArgumentTypes.AccountId, __options: ContractOptions) {
    return buildSubmittableExtrinsic(
      this.__apiPromise,
      this.__nativeContract,
   ...
   * @param { ArgumentTypes.AccountId } account,
   */
  accountDepositOf(underlyingAsset: ArgumentTypes.AccountId, account: ArgumentTypes.AccountId, __options: ContractOptions) {
    return buildSubmittableExtrinsic(
      this.__apiPromise,
      this.__nativeContract,
   ...
   * @param { ArgumentTypes.AccountId } underlyingAsset,
   */
  totalDebtOf(underlyingAsset: ArgumentTypes.AccountId, __options: ContractOptions) {
    return buildSubmittableExtrinsic(
      this.__apiPromise,
      this.__nativeContract,
   ...
   * @param { ArgumentTypes.AccountId } account,
   */
  accountDebtOf(underlyingAsset: ArgumentTypes.AccountId, account: ArgumentTypes.AccountId, __options: ContractOptions) {
    return buildSubmittableExtrinsic(
      this.__apiPromise,
      this.__nativeContract,
   ...
   */
  hasRole(role: number | string | BN, address: ArgumentTypes.AccountId | null, __options: ContractOptions) {
   ...
   * @param { (number | string | BN) } role,
   */
  getRoleAdmin(role: number | string | BN, __options: ContractOptions) {
