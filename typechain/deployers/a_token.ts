...
import AToken from '../contracts/a_token';
...
const fileName = 'a_token';

export default class ATokenDeployer {
	...
	*/
   	async "new" (
		...
		const contractObj = getContractObjectWrapper(this.nativeAPI, AToken, address, this.signer);
		return {
