...
import TestPsp22 from '../contracts/test_psp22';
...
const fileName = 'test_psp22';

export default class TestPsp22Deployer {
	...
	*/
   	async "new" (
		...
		const contractObj = getContractObjectWrapper(this.nativeAPI, TestPsp22, address, this.signer);
		return {
