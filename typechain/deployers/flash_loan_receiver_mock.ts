...
import FlashLoanReceiverMock from '../contracts/flash_loan_receiver_mock';
...
export default class FlashLoanReceiverMockDeployer {
	...
	*/
   	async "new" (
		...
		const contractObj = getContractObjectWrapper(this.nativeAPI, FlashLoanReceiverMock, address, this.signer);
		return {
