...
import Psp22Emitable from '../contracts/psp22_emitable';
...
export default class Psp22EmitableDeployer {
  ...
  async new(name: string, symbol: string, decimal: number | string | BN, __options?: ContractOptions) {
    ...
    const contractObj = getContractObjectWrapper(this.nativeAPI, Psp22Emitable, address, this.signer);
    return {
