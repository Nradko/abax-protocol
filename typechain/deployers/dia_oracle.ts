...
import DiaOracle from '../contracts/dia_oracle';
import { getContractObjectWrapper } from '../shared/utils';
import type BN from 'bn.js';
import FsAPI from 'fs';
import PathAPI from 'path';

const fileName = 'dia_oracle';

export default class DiaOracleDeployer {
  ...
  async new(__options?: ContractOptions) {
    ...
    const contractObj = getContractObjectWrapper(this.nativeAPI, DiaOracle, address, this.signer);
    return {
