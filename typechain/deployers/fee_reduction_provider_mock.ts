...
import FeeReductionProviderMock from '../contracts/fee_reduction_provider_mock';
...
const fileName = 'fee_reduction_provider_mock';

export default class FeeReductionProviderMockDeployer {
	...
	*/
   	async "new" (
		...
		const contractObj = getContractObjectWrapper(this.nativeAPI, FeeReductionProviderMock, address, this.signer);
		return {
