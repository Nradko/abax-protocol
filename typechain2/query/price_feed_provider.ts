...
export default class PriceFeedProviderMethods {
  ...
  setAccountSymbol(
    ...
    return queryOkJSON(this.__apiPromise, this.__nativeContract, this.__callerAddress, 'setAccountSymbol', [asset, symbol], __options, (result) => {
  ...
  getAccountSymbol(
    ...
    return queryOkJSON(this.__apiPromise, this.__nativeContract, this.__callerAddress, 'getAccountSymbol', [asset], __options, (result) => {
