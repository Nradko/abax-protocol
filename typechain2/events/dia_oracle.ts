...
export default class EventsClass {
	...
	public subscribeOnReserveInterestRateModelChangedEvent(callback : (event : EventTypes.ReserveInterestRateModelChanged) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('0xa2e5998ece4e189853e0a528dba8cd3b2c39d178796797d78f80e8b54e4406a9', EVENT_DATA_TYPE_DESCRIPTIONS)) as EventTypes.ReserveInterestRateModelChanged);
		};
	...
	public subscribeOnOwnershipTransferredEvent(callback : (event : EventTypes.OwnershipTransferred) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('0xf363ee3187c9dfdb16a8d9436920bc4e73b5e9cc4ce69a2ad51fdbb4bc105b39', EVENT_DATA_TYPE_DESCRIPTIONS)) as EventTypes.OwnershipTransferred);
		};
	...
	public subscribeOnUpdaterChangedEvent(callback : (event : EventTypes.UpdaterChanged) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('0x30dc916d115e1f67227a6c63b7dfc08de7c2cf284fc50891334f1848abf1481b', EVENT_DATA_TYPE_DESCRIPTIONS)) as EventTypes.UpdaterChanged);
		};
	...
	public subscribeOnTokenPriceChangedEvent(callback : (event : EventTypes.TokenPriceChanged) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('0x28053f279c683bfadeb53d25879f1c616b885477142009a6def019e2e1e5df90', EVENT_DATA_TYPE_DESCRIPTIONS)) as EventTypes.TokenPriceChanged);
		};
