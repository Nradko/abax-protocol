...
export default class EventsClass {
	...
	public subscribeOnExecutedWithSuccessEvent(callback : (event : EventTypes.ExecutedWithSuccess) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('0x63ebc6028b9b9e0cb557e0e706191a3dc930d95984f31d4ea1e6dd8a43127ab0', EVENT_DATA_TYPE_DESCRIPTIONS)) as EventTypes.ExecutedWithSuccess);
		};
	...
	public subscribeOnExecutedWithFailEvent(callback : (event : EventTypes.ExecutedWithFail) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('0x960598314f895ba03934229bcc8a7eeb085c52a05b11eddcd5b11563513f8a25', EVENT_DATA_TYPE_DESCRIPTIONS)) as EventTypes.ExecutedWithFail);
		};
